...
/**
 * A large product-detail moment: the real branded barrel, close and
 * legible, with the heading and a small arrow-caption underneath rather
 * than overlaid on the photo.
 */
      ...
      <Container size="narrow">
        <Reveal>
          <img
            ...
            style={{ aspectRatio: "12 / 5", objectPosition: "48% 50%" }}
          />
        </Reveal>

        <Reveal
          delay={120}
          className="mx-auto mt-10 max-w-content-text text-center lg:mt-14"
        >
          <div className="flex justify-center">
            <SectionLabel>Your Brand, On Something People Keep</SectionLabel>
          </div>
